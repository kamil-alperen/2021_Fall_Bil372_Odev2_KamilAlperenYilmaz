...
const item_error4 = document.getElementsByClassName("label_item_aktiviteID")

let filter_list = []
filter_list[0] = filter_alanID
filter_list[1] = filter_sinifID
filter_list[2] = filter_müdahaleID
filter_list[3] = filter_aktiviteID
            ...
            if(mandatory_item(i)){
                ...
                .then(data => {
                    ...
                    if(data !== 'OK'){
                        ...
                        prev_item_sinifID[i] = item_sinifID[i].value
                        prev_item_müdahaleID[i] = item_müdahaleID[i].value
                        prev_item_aktiviteID[i] = item_müdahaleID[i].value
                        prev_item_sıra[i] = item_sıra[i].value
                    }
                })
            }
