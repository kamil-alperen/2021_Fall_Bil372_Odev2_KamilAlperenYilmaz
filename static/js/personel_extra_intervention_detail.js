...
filter_list[3] = filter_müdahaleID
filter_list[4] = filter_aktiviteID
...
item_list[3] = item_müdahaleID
item_list[4] = item_aktiviteID
...
prev_item_list[3] = prev_item_müdahaleID
prev_item_list[4] = prev_item_aktiviteID
...
filter_create.addEventListener("click", (e) => {
    if(mandatory_filter()){
        ...
        fetch('./extra-intervention-detail', {
            method : 'POST',
            headers: {
